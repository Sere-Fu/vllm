...
def tensor_model_parallel_all_reduce(input_: torch.Tensor) -> torch.Tensor:
    ...
    if out is not None:
        return out
    # print(f"rank: {torch.distributed.get_rank()}, group: {torch.distributed.get_process_group_ranks(get_tensor_model_parallel_group())}, start all reduce")

    torch.distributed.all_reduce(input_,
                                 group=get_tensor_model_parallel_group())
    # print(f"rank: {torch.distributed.get_rank()}, finish all reduce")
